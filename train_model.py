...
from utils.training_alt import AverageMeter, RecorderMeter
from utils.training_alt import adjust_learning_rate, train_target_model, validate, save_checkpoint, accuracy
...
def parse_arguments():
    ...
    # pretrained
    parser.add_argument('--pretrained_dataset', default='cifar10', choices=['cifar10', 'cifar100', 'gtsrb'],
                        help='Used pretrained_dataset (default: cifar10)')
    parser.add_argument('--pretrained_arch', default='resnet20',
                        choices=['resnet20', 'vgg16_cifar', 'resnet50', 'vgg16'],
                        help='Used model architecture for the grad imgs generation process: (default: resnet20)')
...
def main():
    ...
    for epoch in range(args.epochs):
        current_learning_rate = adjust_learning_rate(args.learning_rate, args.momentum, optimizer, epoch, args.gammas,
                                                     args.schedule)
        ...
        # train for one epoch
        train_acc, train_los = train_target_model(pretrained_data_train_loader, net, criterion, optimizer, epoch,
                                                  log,
        ...
        val_acc = validate(pretrained_data_test_loader, net, criterion, log, use_cuda=args.use_cuda)
